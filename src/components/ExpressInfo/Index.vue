        ...
        <el-row>
            <el-form :inline="true" :model="searchForm" ref="searchForm" class="demo-form-inline" size="small">
                <el-form-item prop="order_number">
                    <el-input v-model="searchForm.order_number" size="small" placeholder="请输入订单号"></el-input>
                </el-form-item>
        ...
        <el-row>
            <el-col>
                <TableProxy :url="mainurl" :param="mainparam" :reload="dataTableReload">
                    ...
                    <el-table-column prop="express_name" label="配送物流" align="center">
                    </el-table-column>
        ...
        this.editorOption = quillRedefine(
            {
                // 图片上传的设置
                uploadConfig: {
                    action: URL_CONST.UPLOAD_URL,  // 必填参数 图片上传地址
                ...
                placeholder: '写点什么吧！',  // 可选参数 富文本框内的提示语
                theme: 'snow', // 可选参数 富文本编辑器的风格
                toolOptions: [['bold', 'italic','code-block',{'font':['SimSun','KaiTi','Microsoft Yahei']},
                    { size: [ 'small', false, 'large', 'huge' ]}],['link', 'image']],  // 可选参数  选择工具栏的需要哪些功能  默认是全部
