        ...
        <el-row>
            <el-col :span="24">
                <el-table :data="sumData" :show-header="false" border>
                    ...
                    <el-table-column prop="name" header-align="center" width="200"></el-table-column>n>
            ...
            <el-col :span="24">
                <el-tabs  type="border-card">
                    <el-tab-pane label="成交信息">
                        <el-table :data="tableDataDep1" empty-text="请点击员工显示员工订单信息" border style="width: 100%">
                            ...
                            <el-table-column prop="product_name" label="产品类型" align="center" width="200"></el-table-column>
                            ...
                            <el-table-column prop="created_at" label="开单时间" align="center" width="200"></el-table-column>
                            <el-table-column prop="user_name" label="推广人员" header-align="center"></el-table-column>
                            <el-table-column prop="sale_name" label="销售员工" header-align="center" width="250"></el-table-column>
                            <el-table-column prop="mphone" label="销售电话" header-align="center"></el-table-column>
                        </el-table>
                    </el-tab-pane>
                </el-tabs>
            </el-col>
...
export default {
    ...
    data () {
        return {
            ...
            currentPage4:1,
            tableDataDep:[
                {name:'新乡部',order_num:'30',sale_amount:'10000'},
                {name:'新乡部',order_num:'30',sale_amount:'10000'},
                {name:'新乡部',order_num:'30',sale_amount:'10000'},
                {name:'新乡部',order_num:'30',sale_amount:'10000'},
                {name:'新乡部',order_num:'30',sale_amount:'10000'},
            ...
            tableDataDep1:[
                {customer_name:'新乡部',phone:'30',product_name:'10000',paid_in:'',buy_time:'',created_at:'',user_name:'',sale_name:'',mphone:''},

            ],
            sumData:[
                {name:'汇总',sum_order_num:'150',sum_sale_amount:'50000'},
    ...
    methods:{
        ...
        endDateChange:function(v){
            ...
            this.tableDataDep1 = data.items1;
            this.sumData = data.items2;
    ...
    created(){
        this.toggleTableLoad();
        let mainProxy = new DataProxy("/performanceforspread", this.pageSize, this.mainTableLoad, this);
