                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="快递公司" prop="express" >
                            <el-input class="name-input"  placeholder="" v-model="editForm.express"></el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="是否统一运费" prop="is_unify" >
                            <el-radio class="radio" v-model="editForm.is_unify" :label="0">否</el-radio>
                            <el-radio class="radio" v-model="editForm.is_unify" :label="1">是</el-radio>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8" v-show="isUnify">
                        <el-form-item label="统一运费" prop="unify_fee" >
                            <el-input v-model="editForm.unify_fee"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                    ...
                    <el-row>
                        <el-col :span="18">
                            <el-form-item label="支持包邮吗" prop="is_include" >
                                <el-radio class="radio" v-model="editForm.is_include" :label="0">否</el-radio>
                                <el-radio class="radio" v-model="editForm.is_include" :label="1">是</el-radio>
                    ...
                    <el-row v-show="isInclude">
                        <el-col :span="12">
                            <el-form-item label="满足包邮金额" prop="stand_fee" >
                                <el-input class="name-input"  placeholder="" v-model="editForm.stand_fee"><template slot="append">(含)</template></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="包邮额外费用" prop="stand_extra" >
                                <el-input class="name-input"  placeholder="" v-model="editForm.stand_extra"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row >
                        <el-col :span="18">
                            <el-form-item label="不包邮基本费用" prop="basic_fee" >
                                <el-input class="name-input"  placeholder="" v-model="editForm.basic_fee"></el-input>
                                <span>特殊地区另外存储</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
...
export default {
    ...
    computed:{
        ...
        isInclude(){
            return this.editForm.is_include == '1';
        },
        isUnify(){
            return this.editForm.is_unify == '1';
        }
    },
    methods:{
        getAjaxPromise(model){
            return this.ajaxProxy.update(this.model.id, model);
        },
        onOpen(param){
