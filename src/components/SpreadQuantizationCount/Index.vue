<template>
    <div class="hello">
        ...
        <el-row>
            <el-col :span="24">
                <el-table :data="tableDataDep" v-loading="dataLoad" border highlight-current-row empty-text="暂无数据" fit>
                    <el-table-column label="序号"  align="center" width="65" type="index"></el-table-column>

                    <el-table-column prop="name" label="部门/小组/员工" align="center" width="200"></el-table-column>

                    <el-table-column sortable="custom" prop="spread_lock" label="锁定客户数" align="center">
                    </el-table-column>

                    <el-table-column sortable="custom" prop="recommend_num" label="已推荐个数" align="center">
                    </el-table-column>

                    <el-table-column sortable="custom" prop="spread_trade" label="成交个数" align="center">
                    </el-table-column>

                    <el-table-column sortable="custom" prop="get_cus" label="索取个数" align="center">
                    </el-table-column>
                </el-table>
            </el-col>
        </el-row>
...
export default {
    ...
    data () {
        return {
            ...
            currentPage4:1,
            tableDataDep:[
                {name:'推广N部',spread_lock:'30',recommend_num:'1',spread_trade:'4',get_cus:'7'},
                {name:'驻马店部',spread_lock:'30',recommend_num:'1',spread_trade:'4',get_cus:'7'},
                {name:'平顶山部',spread_lock:'30',recommend_num:'1',spread_trade:'4',get_cus:'7'},
                {name:'周口二部',spread_lock:'30',recommend_num:'1',spread_trade:'4',get_cus:'7'},
                {name:'推广二部',spread_lock:'30',recommend_num:'1',spread_trade:'4',get_cus:'7'},
    ...
    created(){
        this.toggleTableLoad();
        let mainProxy = new DataProxy("/spreadquantizationcount", this.pageSize, this.mainTableLoad, this);
