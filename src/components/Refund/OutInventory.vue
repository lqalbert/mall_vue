                ...
                <el-row>
                    <el-col :span="24">
                        <el-table :data="goods">
                            ...
                            <el-table-column label="入库数量" prop="return_inventory" align="center" width="150"></el-table-column>
                            <el-table-column label="损坏数量" prop="destroy_num" align="center" width="150"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods:{
            onOpen(param){
                if (param.params.out_inventory != 0) {
                    this.$alert("已经出库,不能再次出库", "警告", {
            ...
            getAjaxPromise(model){
                return this.ajaxProxy.outinventory(model.id, model);
            },
            deleteGoods(row){
